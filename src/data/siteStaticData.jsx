...
export const profilePage = {
  ...
  completedProfileForm: {
    ...
    sections: [
      ...
      {
        sectionTitle: "My Faith & Beliefs",
        fields: [
          {
            label: "I follow the religion of",
            name: "religion",
            type: "select",
            options: [
              "Hindu",
          ...
          {
            label: "My community, caste, or tribe is",
            name: "community",
            type: "text",
            placeholder:
              "e.g., Kalita, Ahom, Bodo, Mishing, Bengali, Assamese, etc.",
            required: true,
          },
          {
            label: "My gotra is",
      ...
      {
        sectionTitle: "Where I’m From",
        fields: [
          {
            label: "Currently, I live in",
            name: "city",
            type: "text",
          ...
          {
            label: "But my roots are in",
            name: "nativePlace",
            type: "text",
            placeholder: "e.g., Jorhat, Sivasagar, or Nagaon",
            required: true,
          },
          {
            label: "My home state/region is",
            name: "state",
            type: "select",
            options: [
              "Assam",
          ...
          {
            label: "Please specify your state/region",
            name: "otherState",
            type: "text",
      ...
      {
        sectionTitle: "My Education & Work",
        fields: [
          {
          ...
          {
            label: "I’m currently working in",
            name: "workType",
            type: "select",
            options: [
              "Private Sector",
          ...
          {
            label: "Please specify your work type",
            name: "otherWork",
            type: "text",
          ...
          {
            label: "My annual income is around",
            name: "income",
            type: "select",
            options: [
              "Less than ₹2 LPA",
      ...
      {
        sectionTitle: "My Lifestyle",
        fields: [
          {
            label: "When it comes to food, I’m",
            name: "myDiet",
            type: "select",
            options: [
              "Vegetarian",
          ...
          {
            label: "My hobbies and interests are",
            name: "hobbies",
            type: "multiselect",
            options: [
              "Traveling",
      ...
      {
        sectionTitle: "My Family",
        fields: [
          {
            label: "My father's occupation is",
          ...
          {
            label: "My mother's occupation is",
          ...
          {
            label: "I have this many siblings",
            name: "siblings",
            type: "select",
            options: [
              "No siblings",
            ...
            placeholder: "Select your siblings info",
            required: false,
          },
          {
            label: "Please specify your siblings",
            name: "otherSiblings",
            type: "text",
      ...
      },
      {
        ...
        fields: [
          {
            label: "I’m looking for someone between the ages of",
            name: "preferredAge",
            type: "select",
            options: [
              "18-22",
          ...
          {
            label: "Preferably with height around",
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            name: "otherPreferredEducation",
            type: "text",
            placeholder: "Enter education preference",
            required: true,
            conditional: {
              field: "preferredEducation",
              value: "Other",
            },
          },
          {
            label: "Preferred career/occupation",
            name: "preferredOccupation",
            type: "text",
            placeholder:
              "e.g., Engineer, Doctor, Teacher, Business, IT Professional",
            required: false,
          },
          {
            label: "Financial expectations (if any)",
          ...
          },
          {
            ...
            options: [
              ...
              "Non-smoker & Regular drinker",
              "Occasional smoker & Non-drinker",
              "Occasional smoker & Occasional drinker",
              "Occasional smoker & Regular drinker",
              "Regular smoker & Non-drinker",
      ...
      {
        sectionTitle: "Lifestyle & Family Values",
        fields: [
          {
          ...
          {
            label: "Please specify diet",
            name: "otherPreferredDiet",
            type: "text",
      ...
      {
        sectionTitle: "Personality & More",
        fields: [
          {
            label: "I’d like my partner to have",
