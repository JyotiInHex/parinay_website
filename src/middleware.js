...
export async function middleware(request) {
    ...
    if (pathname.startsWith("/profile") || pathname.startsWith("/buildProfile") || pathname.startsWith("/editProfile")) {
...
export const config = {
    matcher: ["/profile/:path*", "/buildProfile/:path*", "/editProfile/:path*", "/signIn"],
};
