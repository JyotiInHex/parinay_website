    ...
    <div className="w-full h-full select-none grid grid-cols-[40%_1fr] items-start justify-between gap-20">
      <div className="flex flex-col space-y-14">
        ...
        <div className="px-5 space-y-3">
          <FadeInSlideTitle className="w-auto h-auto text-left text-4xl text-zinc-800 font-porinoi-sans font-bold">
            {title}
          </FadeInSlideTitle>
          <Paragraph
            value={subtitle}
            className="justify-start text-lg text-zinc-900 font-medium font-porinoi-sans"
          />
        </div>
            ...
            return (
              <li key={idx}>
                <TooltipText
                  ...
                  customStyle={{
                    backgroundImage: link.backgroundColor,
                    fontSize: "18px",
                  }}
                >
